...
v = VIPCustomer(301, "심청", 1004)  # VIP 커스토머 객체 생성
...
# 제품 지불 비용 출력
print(c.getname() + "님의 지불 금액은 " + str(cost_c) + "원 입니다.")
print(g.getname() + "님의 지불 금액은 " + str(cost_g) + "원 입니다.")
print(v.getname() + "님의 지불 금액은 " + str(cost_v) + "원 입니다.")
